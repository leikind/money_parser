...
describe('moneyParse', function(){
  ...
  it('"2o00.1" should be parsed as 2000.1', function(){
  ...
  it('"0.o1" should be parsed as 0.01', function(){
  ...
  it('"2.o00,01" should be parsed as 2000.01', function(){
  ...
  it('"2 o00.10" should be parsed as 2000.1', function(){
